...
his room covered hashing functions and their uses from various perspectives. Before moving on, we should distinguish between **_hashing_**, **_encoding_**, and **_encryption_**.
